...
if(mysqli_query($link, $query) === true){
    ...
    echo("<p style='color: red;'><br/><b>محصول $pro_name با کد $pro_code به تعداد $pro_qty با قیمت پایه $pro_price تومن را سفارش داده اید</b></p>");
    ...
    echo("<p style='color: blue;'><b>بلیط تور خریداری شده از طریق پست جمهوری اسلامی
    ایران طبق آدرس درج شده ارسال خواهد شد </b></p>");

    echo("<p style='color: blue;'><b>در هنگام تحویل گرفتن پاکت آن را بررسی و از صحت و سالم بودن آن اطمینان حاصل کنید </b></p>");
