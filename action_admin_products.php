...
if ($uploadOk == 1) {
  $query = "INSERT INTO products
    ...
    '$pro_detail')";
  if (mysqli_query($link, $query) === true)
    echo ("<p style='color:green;'><b>تور با موفقیت به انبار اضافه شد </b></p>");
  else
    echo ("<p style='color:yellow;'><b>خطا در ثبت مشخصات تور در انبار</b></p>");
} else
  echo ("<p style='color:red;'><b>خطا در ثبت مشخصات تور در انبار</b></p>");
